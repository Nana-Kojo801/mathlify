...
import { useActions } from '@/components/game-modes/flow-game/flow-game-store'
import { generateFlowGameDifficultyWithRound } from '@/lib/helpers'
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 p-4 rounded-xl bg-background/50 backdrop-blur-sm border border-border/50">
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h2 className="text-lg font-semibold">Flow Marathon</h2>
          </div>
        ...
        <Button
          onClick={() => {
            init(generateFlowGameDifficultyWithRound(1))
            navigate({ to: '/app/competition/play/flow' })
          }}
          size="lg"
