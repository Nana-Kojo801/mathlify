...
export const rapidSettingsSchema = z.object({
  range: z
    .object({
...
const RapidSettings = () => {
  ...
  const form = useAppForm({
    defaultValues: {
      ...
      duration: 7,
    } as z.infer<typeof rapidSettingsSchema>,
    validators: { onChange: rapidSettingsSchema },
  ...
  return (
    <section className="mb-6">
      <div className="flex items-center justify-between mb-3">
        <h2 className="text-xl font-bold">Rapid Settings</h2>
      </div>
