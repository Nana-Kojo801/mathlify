import { useQuestions } from "@/components/game-modes/casual-game/casual-game-store";
import { Eye } from "lucide-react";
import { useState } from "react";

const Review = () => {
  const numbers = useQuestions()
  ...
  return (
    <div className="mt-10 w-full max-w-md bg-card backdrop-blur-md p-5 rounded-xl shadow-lg">
        ...
        {numbers.map((num, index) => (
          <button
            ...
            className={`px-4 py-3 rounded-lg shadow-md grid place-content-center text-white font-semibold text-xl transition active:scale-95 ${
              selectedIndex === index ? "bg-green-500" : "bg-sidebar-accent"
            }`}
